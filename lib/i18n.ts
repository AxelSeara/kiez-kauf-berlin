...
const dictionaries: Record<Locale, Dictionary> = {
  de: {
    ...
    savedOnlyLabel: "Gemerkt",
    openNowOnlyLabel: "Offen jetzt",
    independentOnlyLabel: "Unabhaengig",
  ...
  en: {
    ...
    savedOnlyLabel: "Saved",
    openNowOnlyLabel: "Open now",
    independentOnlyLabel: "Independent",
  ...
  es: {
    ...
    savedOnlyLabel: "Guardadas",
    openNowOnlyLabel: "Abiertas ahora",
    independentOnlyLabel: "Independientes",
